...
//import net.bricklink.data.lego.ibatis.configuration.SourceDataSourceProperties;
...
//@Configuration
//@EnableConfigurationProperties(SourceDataSourceProperties.class)
...
//    @Primary
//    public DataSource sourceDataSource(@Qualifier("sourceDataSourceProperties") final SourceDataSourceProperties dataSourceProperties) {
