                ...
                .forEach(bricklinkInventory -> {
                    ...
                    inventoryIndex.ifPresentOrElse(invIdx -> {
                        ...
                        externalItem.ifPresentOrElse(ei -> {
                            ...
                            ExternalServiceItem externalServiceItem = externalServiceItemDao.findByExternalItemId(ei.getItemId()).orElseThrow(() -> new RuntimeException("Unable to find external service item for itemId [%d], uuid [%s], bricklink item number [%s]".formatted(ei.getItemId(), bricklinkInventory.getUuid(), bricklinkInventory.getBlItemNo())));
                            itemInventory.ifPresentOrElse(ii -> {
                                itemInventoryDao.update(ItemInventory.builder()
                                        ...
                                        .boxNumber(bricklinkInventory.getBoxId())
